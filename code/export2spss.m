% Source: https://www.mathworks.com/matlabcentral/fileexchange/29442-export-data-to-spss-pasw
...
% Hulde!
%
% Function modified on the 30th of May 2022 by Pieter Van den Berghe 
% dutch memo: correcte volorde is export2spss(header(1:2), data(1:2),'naam')
...
try
    ...
    warning('Problem starting SPSS. Saving file.');
    s = 0; w = 0;
end